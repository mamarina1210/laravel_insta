    ...
    <div class="modal-dialog">
        <div class="modal-content border-success">
            <div class="modal-header border-success">
                <h3 class="h5 moda-title text-success">
                <i class="fa-solid fa-user-check"></i> Active user
                </h3>
            </div>
            <div class="modal-body">
                Are you sure you want to activate <span class="dw-bold">{{ $user->name }}</span>?
            </div>
...
<div class="modal fade" id="deactivate-user-{{ $user->id }}">
    <div class="modal-dialog">
        <div class="modal-content border-danger">
            ...
            <div class="modal-body">
                Are you sure you want to deactivate <span class="dw-bold">{{ $user->name }}</span>?
            </div>
            <div class="modal-footer border-0">
